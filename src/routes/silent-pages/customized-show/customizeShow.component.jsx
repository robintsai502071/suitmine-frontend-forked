...
import CollarImg1 from '../../../assests/images/customized-show/領子/單排釦/劍領.png';
import CollarImg2 from '../../../assests/images/customized-show/領子/單排釦/劍領.png';
import CollarImg3 from '../../../assests/images/customized-show/領子/單排釦/修身領.png';
import CollarImg4 from '../../../assests/images/customized-show/領子/雙排釦/標準領.png';
import CollarImg5 from '../../../assests/images/customized-show/領子/雙排釦/劍領.png';
import CollarImg6 from '../../../assests/images/customized-show/領子/雙排釦/修身領.png';
import CollarImg7 from '../../../assests/images/customized-show/領子/雙鈕扣/標準領.png';
import CollarImg8 from '../../../assests/images/customized-show/領子/雙鈕扣/劍領.png';
import CollarImg9 from '../../../assests/images/customized-show/領子/雙鈕扣/修身領.png';
import ButtonImg1 from '../../../assests/images/customized-show/鈕扣/單鈕扣.png';
import ButtonImg2 from '../../../assests/images/customized-show/鈕扣/雙排扣.png';
import ButtonImg3 from '../../../assests/images/customized-show/鈕扣/雙鈕扣.png';
import DoubleImg1 from '../../../assests/images/customized-show/口袋/標準口袋.png';
import DoubleImg2 from '../../../assests/images/customized-show/口袋/無蓋口袋.png';
import DoubleImg3 from '../../../assests/images/customized-show/口袋/斜蓋口袋.png';

import AOS from 'aos';
import 'aos/dist/aos.css';

function CustomizedShow() {
      ...
      <div data-aos="fade-down" className="banner d-none d-lg-block">
        <div className="banner__wrapper mx-auto position-relative">
          <figure className="banner__wrapper__model position-relative w-75 mx-auto position-relative">
            ...
            {/* ------------最底層----------- */}
            <img
              src={require('../../../assests/images/customized-show/main.png')}
              alt=""
        ...
        <div className="banner-rwd">
          <Slider {...settingsRWD} className="banner-rwd__slider">
            <div className="position-relative">
              <img
                src={require('../../../assests/images/customized-show/RWD/1.png')}
            ...
            <div className="position-relative">
              <img
                src={require('../../../assests/images/customized-show/RWD/2.png')}
                className="d-block w-100"
                alt="..."
              />
              <div className="carousel-caption">
            ...
            <div className="position-relative">
              <img
                src={require('../../../assests/images/customized-show/RWD/3.png')}
                className="d-block w-100"
                alt="..."
              />
              <div className="carousel-caption">
            ...
            <div className="col-lg-6 d-none d-lg-flex">
              <div className="intro1__lightbox w-100">
                <div className="intro1__lightbox__thumb position-relative">
                  <img
                    className="w-100"
                    src={require('../../../assests/images/customized-show/intro1/lightbox_thumb.webp')}
                    alt=""
                  />
                  ...
                  >
                    ...
                    >
                      <Image
                        src={require('../../../assests/images/customized-show/intro1/lightbox_1.jpg')}
                      />
                      <Image
                        src={require('../../../assests/images/customized-show/intro1/lightbox_2.jpg')}
                      />
                      <Image
                        src={require('../../../assests/images/customized-show/intro1/lightbox_3.jpg')}
                      />
                    </Image.PreviewGroup>
                  </div>
                </div>
        ...
        <div className="changeColorBlock position-relative">
          <div className="position-relative">
            ...
            <img
              ...
              src={require('../../../assests/images/customized-show/西裝顏色/黑色.png')}
              alt=""
            />
            <img
              className={
              ...
              src={require('../../../assests/images/customized-show/西裝顏色/藍色.png')}
              alt=""
            />
            <img
              className={
              ...
              src={require('../../../assests/images/customized-show/西裝顏色/灰色.png')}
              alt=""
            />
            <img
            ...
            <img
              ...
              src={require('../../../assests/images/customized-show/changeFabricColor/main.png')}
              alt=""
            />
              ...
              <div className=" changeColorBtns d-flex justify-content-around">
                ...
                >
                  <img
                    ...
                    src={require('../../../assests/images/customized-show/changeFabricColor/btns/black.webp')}
                    alt=""
                  />
                </div>
                <div
                ...
                >
                  <img
                    className="w-100 changeColorBtns__link__image"
                    src={require('../../../assests/images/customized-show/changeFabricColor/btns/blue.webp')}
                    alt=""
                  />
                </div>
                <div
                ...
                >
                  <img
                    className="w-100 changeColorBtns__link__image"
                    src={require('../../../assests/images/customized-show/changeFabricColor/btns/gray.webp')}
                    alt=""
                  />
                </div>
              </div>
            ...
            <div className="col-lg-6 d-none d-lg-flex order-first">
              <div className="intro2__lightbox w-100">
                <div className="intro2__lightbox__thumb position-relative">
                  <img
                    className="w-100"
                    src={require('../../../assests/images/customized-show/intro2/lightbox_thumb.webp')}
                    alt=""
                  />
                  <button
                    type="button"
                  ...
                  >
                    ...
                    >
                      <Image
                        src={require('../../../assests/images/customized-show/intro2/lightbox_1.jpg')}
                      />
                      <Image
                        src={require('../../../assests/images/customized-show/intro2/lightbox_2.jpg')}
                      />
                      <Image
                        src={require('../../../assests/images/customized-show/intro2/lightbox_3.jpg')}
                      />
                    </Image.PreviewGroup>
                  </div>
                </div>
